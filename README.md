...
* 07-locate_by_WiFi: indoor location using WiFi fingerprint. Click [here](https://archive.ics.uci.edu/ml/machine-learning-databases/00310/UJIndoorLoc.zip) to download the WiFi data and unzip "UJIndoorLoc.zip".
